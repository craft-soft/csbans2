...
use app\modules\admin\models\{Comment, search\CommentsSearch};
...
class CommentsController extends Controller
{
    ...
    public function actionIndex(Request $request): string
    {
        if (!$request->getIsPjax()) {
            $this->getView()->title = Yii::t('admin/comments', 'PAGE_TITLE_INDEX');
        }
        $this->getView()->params['breadcrumbs'] = [
            Yii::t('admin/comments', 'BREADCRUMBS_INDEX')
        ];
